...
class BERTQA:
    def __init__(self, corpora_paths, pretrained_tokenizer='bert-base-multilingual-cased', pretrained_model='bert-base-multilingual-cased', candidate_format='question'):
        """
        Args:
        ...
        self.tokenizer = BertTokenizer.from_pretrained(pretrained_tokenizer, do_lower_case=False)
